// Firebase DB에 넣은 data (Data 등록 로직 구현을 통해 넣음)

const moviesData = [

  {
    title: '베테랑 2',
    actors: ['황정민', '유아인', '유해진', '신예 배우 추가'],
    description: '베테랑 형사들이 새로운 악당과의 대결에 나서는 이야기.',
    duration: 130, // 러닝타임 예시 (120분에서 약간 증가)
    genre: ['액션', '스릴러'],
    poster: null,
    rating: '15세 이상 관람가',
    release_date: '2024.02.15', // 예상 개봉일 (예시)
  }
